...
<div class="mainDiv">
    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            ...
            <div class="line-rows"><a href="" ><?= $view_assignment["pdf"]; ?></a></div>
            <div class="" id="div_new_assignment">
                <form action="addNewAssignment" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <p>Assignment Name</p>
                            <input type="text" name="assignmentName" value="<?php echo $view_assignment["assignmentName"]; ?>" disabled>
                        </div>
                        <div class="col-md-6">
                            <p>Year</p>
                            <input type="text" name="year" value="<?php echo $view_assignment["year"]; ?>" disabled>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                           <p>Subject</p>
                            <input type="text" name="subject" value="<?php echo $view_assignment["subject"]; ?>" disabled> 
                        </div>
                        <div class="col-md-6">
                            <p>Semester</p>
                            <input type="text" name="semester" value="<?php echo $view_assignment["semester"]; ?>" disabled> 
                        </div>
                    </div>
                    <br><br>
                </form>
