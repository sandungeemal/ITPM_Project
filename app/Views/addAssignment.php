    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            ...
            <div class="" id="div_new_assignment">
                <form action="store-assignment" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <p>Assignment Name</p>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="year" required>
                                ...
                                <option value="1">1ˢᵗ Year</option>
                                <option value="2">2ⁿᵈ Year</option>
                                <option value="3">3ʳᵈ Year</option>
                                <option value="4">4ᵗʰ Year</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="semester" required>
                                ...
                                <option value="1">1ˢᵗ Semester</option>
                                <option value="2">2ⁿᵈ Semester</option>
                            </select>
                        </div>
                    </div>
