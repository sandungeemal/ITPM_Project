...
<div class="mainDiv">
    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            <div class="line-rows"><a id="add_student" onclick="clickFunction(this)">Student Registration</a></div>
            <div class="hiddenDiv" id="div_add_student">
                <form action="studentRegister" method="post" onsubmit="return checkStudent(this)">
                    <p>First Name</p>
            ...
            <div class="line-rows"><a id="course_change" onclick="clickFunction(this)">Edit Student Details</a></div>
            <div class="hiddenDiv" id="div_course_change">
                <form action="studentRegister" method="post" onsubmit="return checkStudentEdit(this)">
            ...
            <div class="line-rows"><a id="std_delete" onclick="clickFunction(this)">Remove Student</a></div>
            <div class="hiddenDiv" id="div_std_delete">
                <form action="studentRegister" method="post" onsubmit="return checkStudentDelete(this)">
                    <p>Student Registration Number</p>
