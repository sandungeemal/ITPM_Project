    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            ...
            <div class="hiddenDiv" id="div_email_change">
                <form action="stdSettings" method="post" onsubmit="return changeEmail(this);">
                    <p>Current Email</p>
            ...
            <div class="hiddenDiv" id="div_phone_change">
                <form action="stdSettings" method="post" onsubmit="return changePhone(this);">
                    <p>Phone Number</p>
            ...
            <div class="hiddenDiv" id="div_pass_change">
                <form action="stdSettings" method="post" onsubmit="return changePassword(this);">
