...
<div class="mainDiv">
    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            <div class="line-rows"><a href="stdCourse"><?php if(isset($_SESSION['courseName'])){ echo $_SESSION['courseName'];} ?></a></div>
            <div class="reservations">
                <table class="reservationTable">
                    <tr>
                        <th class="tableNew">User picture</th>
                        <th class="tableNew">First Name / Last Name / Surname</th>
                        <th class="tableNew">Registration Number</th>
                    </tr>
                    <?php
                    foreach ($participants as $row){
                        if ($row->image==null||$row->image==""){
                            $image='siteimage/user.png';
                        }else{
                            $image=base64_decode($row->image);
                        }
                        echo '
                            <tr>
                                <td class="tableNew"><img src="'.base_url().$image.'" style="width: 60px"></td>
                                <td class="tableNew">'.$row->fname.' '.$row->lname.' '.$row->sname.'</td>
